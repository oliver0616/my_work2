...
\begin{tikzpicture}
	...
	\draw [draw=blue] plot [domain=0.1:4] (\x,{log10(1+\x)}) node[anchor=west,blue]{\tiny$y=log(1+x)$} ;
	\draw [draw=green] plot [domain=0.1:4] (\x,{log10(1+log10(1+\x))}) node[anchor=west,green]{\tiny $y=log(1+log(1+x))$};
\end{tikzpicture}
\end{document}